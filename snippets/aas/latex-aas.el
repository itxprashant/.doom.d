...
(defun laas-mathp ()
  ...
  (cond
   ...
   ;; ((derived-mode-p 'org-mode) (laas-org-mathp)) ;; For every \begin{...} .... \end{...} environment
   ((derived-mode-p 'org-mode) (texmathp))
...
(defvar laas-basic-snippets
  '(:cond laas-mathp
    ...
    "clr"    (lambda () (interactive) (yas-expand-snippet "\\left\\\\{ $1 \\right\\\\}$0"))
